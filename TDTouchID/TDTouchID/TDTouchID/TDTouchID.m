...
- (void)td_showTouchIDWithDescribe:(NSString *)desc FaceIDDescribe:(NSString *)faceDesc AuthFallbackTitle:(NSString *)backTitle BlockState:(StateBlock)block {
    ...
    switch (supperType) {
        ...
        {
            descStr = desc.length == 0 ? @"通过Home键验证已有指纹" : desc;
        }
            break;
    ...
    if (@available(iOS 8.0, *)) {
        ...
        if ([context canEvaluatePolicy:LAPolicyDeviceOwnerAuthenticationWithBiometrics error:&error]) {
            ...
            [context evaluatePolicy:LAPolicyDeviceOwnerAuthenticationWithBiometrics localizedReason:descStr reply:^(BOOL success, NSError * _Nullable error) {
                ...
                if (success) {
                    dispatch_async(dispatch_get_main_queue(), ^{
                        [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 验证成功");
                    ...
                    switch (error.code) {
                        case LAErrorAuthenticationFailed:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 验证失败");
                        ...
                        case LAErrorUserCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 被用户手动取消");
                        ...
                        case LAErrorUserFallback:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"用户不使用TouchID,选择手动输入密码");
                        ...
                        case LAErrorSystemCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 被系统取消 (如遇到来电,锁屏,按了Home键等)");
                        ...
                        case LAErrorPasscodeNotSet:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 无法启动,因为用户没有设置密码");
                        ...
                        case LAErrorTouchIDNotEnrolled:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 无法启动,因为用户没有设置TouchID");
                        ...
                        case LAErrorTouchIDNotAvailable:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 无效");
                        ...
                        case LAErrorTouchIDLockout:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"TouchID 被锁定(连续多次验证TouchID失败,系统需要用户手动输入密码)");
                        ...
                        case LAErrorAppCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"当前软件被挂起并取消了授权 (如App进入了后台等)");
                        ...
                        case LAErrorInvalidContext:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"当前软件被挂起并取消了授权 (LAContext对象无效)");
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                [TDTouchID sharedInstance].disableLogs ? : NSLog(@"当前设备不支持TouchID");
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [TDTouchID sharedInstance].disableLogs ? : NSLog(@"系统版本不支持TouchID (必须高于iOS 8.0才能使用)");
...
- (void)td_showTouchIDWithDescribe:(NSString *)desc FaceIDDescribe:(NSString *)faceDesc BlockState:(StateBlock)block {
    [self td_showTouchIDWithDescribe:desc FaceIDDescribe:faceDesc AuthFallbackTitle:nil BlockState:block];
}
